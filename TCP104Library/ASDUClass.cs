...
namespace TCP104Library
{
    public class ASDUClass
    {
                ...
                case TransRes.Active:
                    {
                        switch (funType)
                        {
                            case FunType.ClockConfirm:
                                ...
                                this.type = funType;
                                this.apduAddr = 1;
                                this.data.Add(new DataStruct() { Addr = 0, Time = DateTime.Now });
                                break;
                            case FunType.CalAll:
                                this.sqn = 1;
                                this.SetTransRes(false, false, active);
                                this.type = funType;
                                this.apduAddr = 1;
                                this.data.Add(new DataStruct() { Addr = 0, Data = 0x14 });
                                break;
                        }
                    }
                    break;
        ...
        public void Pack(string txt)
        {
            ...
            {
                this.data.Add(new DataStruct() { Data = item });
            }
        }
